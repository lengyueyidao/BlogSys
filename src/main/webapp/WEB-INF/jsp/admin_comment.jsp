        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="admin_comment.jsp" class="active-menu"><i class="glyphicon glyphicon-comment"></i> <strong>评论管理</strong></a>
                    </li>
                    <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr>
											<td>RE:正则表达式30分钟入门教程</td>
											<td>污鸡魔王吊炸天！</td>
											<td style="text-align:center;">污鸡魔王</td>
											<td style="text-align:center;">2016-05-12 19:48</td>
