        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="admin_trash.jsp" class="active-menu"><i class="glyphicon glyphicon-trash"></i> <strong>回收站</strong></a>
                    </li>
                </ul>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th width="60%">标题</th>
                                            <th width="5%" style="text-align:center;">阅读</th>
                                            <th width="5%" style="text-align:center;">评论</th>
                                    ...
                                    <tbody>
                                        <tr>
											<td>正则表达式30分钟入门教程（2016-05-12 19:48）正则表达式30分钟入门教程（2016-05-12 19:48）正则表达式30分钟入门教程（2016-05-12 19:48）正则表达式30分钟入门教程（2016-05-12 19:48）</td>
											<td style="text-align:center;">154</td>
											<td style="text-align:center;">23</td>
											<td style="text-align:center;">禁止评论</td>
											<td style="text-align:center;">编辑|删除</td>
										</tr><tr>
											<td>正则表达式30分钟入门教程（2016-05-12 19:48）</td>
											<td style="text-align:center;">154</td>
											<td style="text-align:center;">23</td>
											<td style="text-align:center;">禁止评论</td>
											<td style="text-align:center;">编辑|删除</td>
